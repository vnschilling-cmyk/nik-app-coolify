...
export default function BiblePageClient({ verses, lessons, book, chapter, allBooks }: BiblePageClientProps) {
    ...
    return (
        <div className="pb-20">
            <header className="sticky top-0 z-40 bg-background/95 dark:bg-slate-800/95 backdrop-blur-md border-b border-zinc-200 dark:border-slate-700 px-4 h-14 flex items-center justify-between shadow-sm">
                <h1
